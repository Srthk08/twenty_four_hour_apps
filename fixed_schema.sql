-- =====================================================
-- FIXED SCHEMA - INCLUDES ALL REQUIRED COLUMNS
-- =====================================================
-- This schema includes the missing product_type column
-- that was causing the "Could not find the 'product_type' column" error
-- =====================================================
...
CREATE TABLE customization_forms (
    ...
    -- Product Information (THESE WERE MISSING!)
...
SELECT 'customization_forms table created successfully with ALL required columns' as status;

-- Show table structure to confirm all columns exist
SELECT 
    column_name,
    data_type,
    is_nullable,
