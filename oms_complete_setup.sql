-- Complete Order Menu System (OMS) Database Setup
...
-- 3. Create OMS-specific function with duplicate prevention
...
-- 8. Test the OMS setup with different scenarios
...
-- Test 4: Same email, same project, same restaurant, but different data (should update)
SELECT * FROM upsert_oms_customization(
    'test@example.com',
    'My Restaurant App',
    'Delicious Bites',
    'John Doe Updated',
    '456 Updated Street, City',
    'John Doe Updated',
    '+91 9999999999',
    NULL,
    NULL,
    NULL,
    NULL,
    '[{"id": "cat1", "name": "Updated Starters"}]'::jsonb,
    '[{"id": "item1", "name": "Updated Item", "price": 150}]'::jsonb,
    '#FF00FF',
    '#00FFFF',
    '#FFFF00',
    '#FFFFFF',
...
-- 9. Verify all data in the table
SELECT 
    id,
    user_email,
    project_name,
