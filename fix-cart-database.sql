-- Fix Cart Customizations Table
-- Run this in Supabase SQL Editor to ensure the table exists and works properly
...
-- ON CONFLICT (user_email, product_id) DO UPDATE SET updated_at = now();
