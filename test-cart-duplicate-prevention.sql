-- Test Cart Customization Duplicate Prevention
-- Run this in Supabase SQL Editor to test the duplicate prevention logic
...
SELECT upsert_cart_customization(
    ...
    'john@example.com',                    -- contact_email
    '+1234567890',                         -- contact_phone
    'https://example.com/tvlogo.png',      -- DIFFERENT restaurant_logo_url
    'tvlogo.png',                          -- DIFFERENT restaurant_logo_filename
    2048000,                               -- DIFFERENT restaurant_logo_size
    'image/png',                           -- restaurant_logo_type
    'xyz789hash1',                         -- DIFFERENT restaurant_logo_hash
    '["https://example.com/tv1.jpg"]'::jsonb, -- DIFFERENT menu_photos_urls
    '["tv1.jpg"]'::jsonb,                  -- DIFFERENT menu_photos_filenames
    '[3072000]'::jsonb,                    -- DIFFERENT menu_photos_sizes
    '["image/jpeg"]'::jsonb,               -- menu_photos_types
    '["hash3"]'::jsonb,                    -- DIFFERENT menu_photos_hashes
    '#8B5CF6',                             -- primary_color
    '#1E1B4B',                             -- secondary_color
    '#F59E0B',                             -- accent_color
    '#FFFFFF',                             -- text_color
...
-- Test 5: Same user, same product, different images (should INSERT new)
SELECT upsert_cart_customization(
    'john@example.com',                    -- SAME user_email
    gen_random_uuid(),                     -- user_id
    '1',                                   -- SAME product_id
    ...
    25000.00,                              -- base_price
    29500.00,                              -- total_amount
    'John New Pizza Palace',               -- project_name
    'John New Pizza Palace App',           -- app_name
    'John Doe',                            -- contact_person
    'New requirements',                    -- product_description_custom
    'New Pizza Palace',                    -- restaurant_name
    'chinese',                             -- cuisine_type
    'john@example.com',                    -- contact_email
    '+1234567890',                         -- contact_phone
    'https://example.com/newlogo.png',     -- DIFFERENT restaurant_logo_url
    'newlogo.png',                         -- DIFFERENT restaurant_logo_filename
    1536000,                               -- DIFFERENT restaurant_logo_size
    'image/png',                           -- restaurant_logo_type
    'def456hash2',                         -- DIFFERENT restaurant_logo_hash
    '["https://example.com/newmenu1.jpg", "https://example.com/newmenu2.jpg"]'::jsonb, -- DIFFERENT menu_photos_urls
    '["newmenu1.jpg", "newmenu2.jpg"]'::jsonb, -- DIFFERENT menu_photos_filenames
    '[2560000, 1920000]'::jsonb,           -- DIFFERENT menu_photos_sizes
    '["image/jpeg", "image/jpeg"]'::jsonb, -- menu_photos_types
    '["hash4", "hash5"]'::jsonb,           -- DIFFERENT menu_photos_hashes
    '#FF1493',                             -- primary_color
    '#2F4F4F',                             -- secondary_color
    '#FFD700',                             -- accent_color
    '#000000',                             -- text_color
    'New additional requirements'          -- additional_requirements
) as cart_id_5;
...
-- 3. john@example.com + product 2 + different images = 1 record (new)
-- 4. john@example.com + product 1 + different images = 1 record (new)
-- Total: 4 records, no duplicates
