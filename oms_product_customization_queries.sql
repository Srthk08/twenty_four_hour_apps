-- OMS Product Customization Form Queries
-- This creates a separate table for OMS product customization data
-- Run this in Supabase SQL Editor

-- 1. Drop existing functions and table if they exist
DROP FUNCTION IF EXISTS upsert_oms_product_customization(
    VARCHAR(255),
    VARCHAR(255),
    VARCHAR(255),
    VARCHAR(255),
...
DROP FUNCTION IF EXISTS get_oms_product_customizations_by_user(VARCHAR(255));
DROP FUNCTION IF EXISTS check_oms_product_duplicate(VARCHAR(255), VARCHAR(255), VARCHAR(255), VARCHAR(255), VARCHAR(20));

-- Drop the table if it exists
DROP TABLE IF EXISTS oms_product_customizations CASCADE;

-- 2. Create OMS Product Customization table
...
-- 5. Create OMS Product Customization function with duplicate prevention
...
-- 6. Create function to get OMS product customizations by user
...
-- 9. Test the OMS Product Customization setup
...
-- Test 2: Same contact person and phone (should update existing)
SELECT * FROM upsert_oms_product_customization(
