import"./Toast.astro_astro_type_script_index_0_lang.FM9xDykS.js";import"https://unpkg.com/@supabase/supabase-js@2";const o=document.getElementById("payment-form");o?.addEventListener("submit",async n=>{n.preventDefault();const e=o.querySelector('button[type="submit"]');e.textContent,e.disabled=!0,e.innerHTML=`
