import"./ProductDialog.astro_astro_type_script_index_0_lang.C4tfig-4.js";import"https://unpkg.com/@supabase/supabase-js@2";const o=document.getElementById("payment-form");o?.addEventListener("submit",async n=>{n.preventDefault();const e=o.querySelector('button[type="submit"]');e.textContent,e.disabled=!0,e.innerHTML=`
