...
Error: `+u.message)}finally{e.disabled=!1,e.textContent=s}});const n=document.getElementById("ticketModal");n&&n.addEventListener("click",function(a){a.target===this&&g()})}function j(t){const e=document.createElement("div");e.className="fixed top-4 right-4 bg-green-500 text-white px-6 py-4 rounded-lg shadow-lg z-50",e.innerHTML=`
