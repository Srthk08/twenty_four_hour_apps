import{c as u}from"./index.BFAZBQoJ.js";import"./ProductDialog.astro_astro_type_script_index_0_lang.C1LHbjNP.js";import"https://unpkg.com/@supabase/supabase-js@2";import"./AdminLayout.astro_astro_type_script_index_3_lang.LJYybVYx.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2";const d="YOUR_SUPABASE_URL",m="YOUR_SUPABASE_ANON_KEY",a=u(d,m);async function s(){try{const{data:e,error:t}=await a.from("profiles").select("*").eq("role","menu_operator").order("created_at",{ascending:!1});if(t){console.error("Error loading menu operators:",t);return}p(e)}catch(e){console.error("Error loading menu operators:",e)}}function p(e){const t=document.getElementById("menu-operators-list");if(!e||e.length===0){t.innerHTML='<p class="text-gray-500 text-center py-8">No Menu Operators assigned yet</p>';return}t.innerHTML=e.map(r=>`
