...
const mockProducts: Product[] = [
  {
    ...
    category: 'restaurant',
    base_price: 25000,
    featured_image: 'https://mir-s3-cdn-cf.behance.net/project_modules/1400/880687216188351.677c1628ee128.png',
    gallery: [],
  ...
  },
  {
    ...
    category: 'restaurant',
    base_price: 25000,
    featured_image: 'https://i.pinimg.com/736x/af/62/3c/af623c96836f449885d2fb2b1dcbac82.jpg',
    gallery: [],
